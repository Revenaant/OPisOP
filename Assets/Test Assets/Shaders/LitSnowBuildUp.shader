Shader "Toon/Lit Snow Buildup PasteBin" 
{
	Properties
	{
...
#pragma lighting ToonRamp exclude_path:prepass
		...
		void surf(Input IN, inout SurfaceOutput o) {
			...
			if (dot(o.Normal, _SnowAngle.xyz) >= _SnowSize - 0.4) 
			{ // if dot product result is higher than snow amount, we turn it into snow
